...
# Name of backbone for camera model
_C.MODEL.CAMERA_NAME = 'resnet50'
...
# cluster dist threshold parameter for DBSCAN
...
# use transfered data or not
_C.TGT_UNSUPDATA.TRANSFERED = 'original'
...
# use transfered data or not
_C.SRC_DATA.TRANSFERED = 'original'
...
_C.TEST_DATA = CN()
# List of the dataset names for val
_C.TEST_DATA.NAMES = ('market1501')
# Root directory where val datasets should be used
_C.TEST_DATA.TRAIN_DIR = ('./data')
...
# Probablity of sampling from multi-datasets: source, unsupdata
_C.DATALOADER.SAMPLER_PROB = [1.0,0.0]
...
_C.LOSS.LOSS_TYPE = ['trp_cls','trp_cls']
# If train with label smooth, options: 'on', 'off'
_C.LOSS.IF_LABELSMOOTH = 'off'
# loss weights
_C.LOSS.LOSS_WEIGHTS = [1.0,1.0]
# Margin of triplet loss
_C.LOSS.TRP_MARGIN = 0.3
# Add L2 norm for triplet loss or not
_C.LOSS.TRP_L2 = 'yes'
# Add hard negative mining or not
_C.LOSS.TRP_HNM = 'yes'
# epsilon parameter for label smooth
_C.LOSS.LABELSMOOTH_EPSILON = 0.1
...
# Settings of weight decay for bias
...
_C.TEST.WEIGHT = ""
# Path to trained camera model
_C.TEST.CAMERA_WEIGHT = ""
